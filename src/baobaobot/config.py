...
.env loading priority: local .env (cwd) > $BAOBAOBOT_DIR/.env (default ~/.baobaobot).
...
class Config:
    ...
    def __init__(self) -> None:
        ...
        self.tmux_session_name = os.getenv("TMUX_SESSION_NAME", "baobaobot")

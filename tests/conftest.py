"""Root conftest — sets env vars BEFORE any baobao module is imported.
...
discovers any test that transitively imports baobao.
"""
...
os.environ["BAOBAO_DIR"] = tempfile.mkdtemp(prefix="baobao-test-")

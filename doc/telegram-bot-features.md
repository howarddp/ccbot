...
## 2. Feature Implementation Status in BaoBaoClaude
...
### Currently Forwarded by BaoBaoClaude
...
|---------|---------------------|----------|
| `/clear` | ↗ Clear conversation history | Wipes conversation, starts fresh. BaoBaoClaude also clears session association |
